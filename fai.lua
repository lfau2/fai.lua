...
Lfau is really sigma and cool like tghat
			...
			do 
				Messages = {
					...
					["Lunar"] = {
						...
						"fai fai fai RAHHHHH",
						"Slammed by fai",
						"YOU GOT SLAMMED BY fai",
						"SEEMS LIKE YOU NEED fai GG/fai",
						"GG/fai GG/fai GG/fai",
						"GG/fai <-- THIS WILL LET YOU COPE WITH YOUR ISSUES",
						"WHAT YOU CANT BEAT fai?",
						"PRO TIP: BUY fai",
					},
				}
				utx = {
...
local Window = Library:Window({Size = UDim2.new(0,580,0,600)}) do 
	...
	local Config = Window:Page({Name = "Settings"}) do
		...
		Menu:Label({Centered = true, Name = "Credits: Lfau \nPortal : User Interface"})
		--
...
Library:Notification("Loaded Fai.cc in " .. Floor((tick() - loadingTime) * 1000)  .."ms", 3, Library.Accent, flags["Notification Position"])
