...
do 
	...
	do 
		...
		do 
			...
			utility.drawings["Sub"] = utility:drawObject("Text", {Outline = true, Text = "fai", Color = Color3.new(1, 1, 1), Size = 13})
			utility.drawings["Domain"] = utility:drawObject("Text", {Outline = true, Text = ".cc", Color = Color3.fromRGB(132, 108, 188), Size = 13})
			--
